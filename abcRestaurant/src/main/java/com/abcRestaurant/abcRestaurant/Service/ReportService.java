...
public class ReportService {
    ...
    public byte[] generateBill(String orderId) throws DocumentException, IOException {
        ...
        PdfPCell deliveryCell = new PdfPCell(new Phrase("Delivery Charges: " + String.format("%.2f",
                order.getDeliveryCharges()), detailFont));
        ...
        PdfPCell discountCell = new PdfPCell(new Phrase("Discount Amount: " +
                String.format("%.2f", order.getDiscountAmount()), detailFont));
        ...
        PdfPCell finalAmountCell = new PdfPCell(new Phrase("Final Amount: "
                + String.format("%.2f", order.getFinalAmount()), finalAmountFont));
